  ...
  m = n(
    ...
    [
      ...
      n('p', null, [
        s('An '),
        n('code', null, 'Error'),
        s(' should be always a real '),
        n('code', null, 'Error'),
        s(' type extended from the JavaScript/Typescript '),
        n('code', null, 'Error'),
        s(' class.')
      ])
    ],
...
<span class="token builtin">console</span><span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>tasks<span class="token punctuation">.</span>errors<span class="token punctuation">)</span>
  ...
  R = { class: 'hint-container details' },
  D = e(
...
function j(P, B) {
  ...
  return (
    ...
    d('div', null, [
      ...
      k(' more '),
      m,
      n('div', h, [f, n('p', null, [s('You can find the related examples '), n('a', g, [s('here'), a(c)]), s('.')])]),
      w,
      n('h3', y, [_, s(' Modes '), a(l, { type: 'warning' }, { default: o(() => [a(i, { icon: 'mdi:github' }), x]), _: 1 })]),
      E,
      n('p', null, [
        a(p, { to: '/api/classes/ListrError.html' }, { default: o(() => [T]), _: 1 }),
        s(' class extends the default '),
        L,
        s(
      ...
      O,
      n('p', null, [
        s('A listr error can be caused by multiple reasons, for a better explanation of why that particular error occurred, a type property on the '),
        I,
        s(' exists in the form of enum '),
        a(p, { to: '/api/enums/ListrErrorTypes.html' }, { default: o(() => [F]), _: 1 }),
        s('.')
      ]),
      A,
      n('details', R, [n('summary', null, [a(i, { icon: 'ph:terminal-window-duotone' }), s(' Output')]), D]),
      n('details', S, [n('summary', null, [a(i, { icon: 'fluent:text-description-24-filled' }), s(' Flow')]), H])
    ])
  )
}
const C = r(v, [
  ['render', j],
  ['__file', 'error-handling.html.vue']
])
export { C as default }
