...
import {
  ...
  ListrRendererValue
} from '@interfaces/listr-renderer.interface'
...
export class Listr<Ctx = ListrContext, Renderer extends ListrRendererValue = ListrDefaultRendererValue, FallbackRenderer extends ListrRendererValue = ListrFallbackRendererValue> {
  ...
  /** Runs the task list and returns the context back. */
  ...
  /** Performs all the checks required before running the task. */
  ...
  /** Runs a singular task if enabled, through wrapper. **/
