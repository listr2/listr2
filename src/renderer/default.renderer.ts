...
export class DefaultRenderer implements ListrRenderer {
  ...
  public end (): void {
    ...
    if (!this.options.clearOutput) {
      ...
      this.updateManager.erase(this.pointerTotal + 1 - this.updateManager.outside)
    }
  ...
  private getSymbol (task: Task<ListrContext, typeof DefaultRenderer>, data = false): string {
    ...
    return !data ? chalk.dim(figures.main.squareSmallFilled) : figures.main.pointerSmall
  }
